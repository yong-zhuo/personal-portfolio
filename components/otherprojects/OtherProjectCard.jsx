...
export const OtherProjectCard = ({ proj }) => {
  return (
    <div className="grid-item card bg-primary-content w-full md:w-[300px] lg:w-[400px] xl:w-[320px] h-[240px] md:h-[280px] xl:h-[290px] shadow-md duration-500 hover:scale-105 hover:shadow-xl">
